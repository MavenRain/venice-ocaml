...
suites="test_codec test_bytes test_jsonx test_modelx test_paramsx test_msgx"
for t in $suites; do
...
core="errx.ml bytesx.ml hexx.ml b64x.ml jsonx.ml paramsx.ml modelx.ml msgx.ml"
if [ -n "$core" ]; then
  files=""
